...
function TeacherLogin() {
	...
	const submitHandler = (e) => {
        e.preventDefault()
        axios.post('http://learnzilla.herokuapp.com/teacher/login/', data)
        .then(response => {
    ...
    const submitHandler1 = (e) => {
        e.preventDefault()
        axios.get('http://learnzilla.herokuapp.com/teacher/logout/')
        .then(response => {
    ...
    return (
		...
		<div className="card">
			<center><h3 ClassName="card-header bg-primary text-white p-3">Teacher Login Form</h3></center>
