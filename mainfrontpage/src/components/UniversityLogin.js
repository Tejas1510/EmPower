...
function UniversityLogin() {
	...
	const submitHandler = (e) => {
        e.preventDefault()
        axios.post('http://learnzilla.herokuapp.com/institution/login/', data)
        .then(response => {
    ...
    const submitHandler1 = (e) => {
        e.preventDefault()
        axios.get('http://learnzilla.herokuapp.com/institution/logout/')
        .then(response => {
    ...
    return (
		...
		<div className="card">
			<center><h3 ClassName="card-header bg-primary text-white p-3">University Login Form</h3></center>
